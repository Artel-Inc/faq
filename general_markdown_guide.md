...
[MarkText](https://www.marktext.cc/), очень удобный интерактивный редактор, позволяет компилировать в pdf с заданным стилем.

[VScode](https://code.visualstudio.com/), двух оконный редактор (редактирование/просмотр), из преимуществ скорее всего он уже у вас есть.
