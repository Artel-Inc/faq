# Markdown как стандарт оформления документации
...
- Любой текстовой редактор (не очень удобно)
- Специализированные текстовые редакторы

Могу выделить:

[Typora](https://typora.io/), очень удобный интерактивный редактор, позволяет компилировать в pdf с заданным стилем (Платный).

[VScode](https://code.visualstudio.com/), двух оконный редактор (редактирование/просмотр), из преимуществ скорее всего он уже у вас есть :) Есть способ сохранения в pdf 
